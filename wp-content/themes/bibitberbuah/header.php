...
<html lang="en">
  <head>
    ...
    <link href="<?php echo get_bloginfo('template_directory');?>/custome.css" rel="stylesheet">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="<?php echo get_bloginfo('template_directory');?>/assets/js/ie-emulation-modes-warning.js"></script>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-5 col-md-4">
        ...
        <img alt="Brand" width="80%" src="<?php echo get_bloginfo( 'template_directory' );?>/images/logo4.png"></a>
      </div>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img src="<?php echo get_bloginfo('template_directory');?>/images/tes1.jpg" alt="Los Angeles" style="width:100%;">
            </div>

            <div class="item">
              <img src="<?php echo get_bloginfo('template_directory');?>/images/tes1.jpg" alt="Chicago" style="width:100%;">
            </div>
          
            <div class="item">
              <img src="<?php echo get_bloginfo('template_directory');?>/images/tes1.jpg" alt="New york" style="width:100%;">
            </div>
          </div>
